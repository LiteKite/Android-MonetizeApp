...
public class StoreItemVM {
	...
	/**
	 * Checks whether the Popcorn Store Product Item was purchased or not and it tells the
	 * updates to the view.
	 * <p>
	 * "Buy" option will be available if it was not purchased. "Purchased" will be shown otherwise.
	 */
