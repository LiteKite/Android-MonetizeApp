...
package com.litekite.inappbilling.worker;
...
/**
 * An Executor that uses {@link ThreadPoolExecutor} with the available thread pool size
 * and runs work in background.
 *
 * @author Vignesh S
...
public class WorkExecutor implements Executor {
	...
	/**
	 * Creates a new instance of {@link WorkExecutor} and
	 * it creates a new {@link ThreadPoolExecutor}
	 */
	@Inject
	public WorkExecutor() {
